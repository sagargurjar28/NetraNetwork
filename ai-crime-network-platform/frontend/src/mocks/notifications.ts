...
export const mockNotifications: MockNotification[] = [
  {
    ...
    body: 'Operation Black Kite (11111111-1111-1111-1111-111111111111) was assigned to you.',
    createdAt: minutesAgo(4),
    route: '/network/cases/11111111-1111-1111-1111-111111111111',
  },
  {
    id: 'notif-2',
    type: 'document_uploaded',
    title: 'Document uploaded',
    body: 'FIR_2024_112.pdf was added to 11111111-1111-1111-1111-111111111111.',
  ...
  },
  {
    ...
    type: 'document_uploaded',
    title: 'Document uploaded',
    body: 'Seizure_Memo_33.docx was added to 11111111-1111-1111-1111-111111111111.',
  ...
  },
  {
    ...
    type: 'case_assigned',
    title: 'New case assigned',
    body: 'Narcotics Corridor (11111111-1111-1111-1111-111111111111) was assigned to you.',
