...
function seed(): Map<string, BoardState> {
  ...
  const pins: BoardPin[] = [
    { id: 'pin-vikram', board_id: boardId, entity_type: 'person', entity_id: 'ENT-001', label: 'Vikram Singh', content: { gender: 'male', role: 'suspect', phone: '+91 98XXX X2100', address: 'Sector 7, Old Mandi', associates_count: 12, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: ['FIR-2024-112'] }, x: 420, y: 280, color: '#dc2626' },
    { id: 'pin-anita', board_id: boardId, entity_type: 'person', entity_id: 'ENT-002', label: 'Anita Rao', content: { gender: 'female', role: 'victim', phone: '+91 98XXX X2101', address: 'Lake View Apartments', associates_count: 7, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: [] }, x: 640, y: 200, color: '#dc2626' },
    { id: 'pin-rahul', board_id: boardId, entity_type: 'person', entity_id: 'ENT-003', label: 'Rahul Mehta', content: { gender: 'male', role: 'witness', phone: '+91 98XXX X2102', address: 'Freight Corridor Quarters', associates_count: 4, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: [] }, x: 240, y: 180, color: '#dc2626' },
    { id: 'pin-priya', board_id: boardId, entity_type: 'person', entity_id: 'ENT-006', label: 'Priya Desai', content: { gender: 'female', role: 'related', phone: '+91 98XXX X2106', address: 'Lake View Apartments', associates_count: 2, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: [] }, x: 850, y: 330, color: '#dc2626' },
    { id: 'pin-sun', board_id: boardId, entity_type: 'organization', entity_id: 'ENT-004', label: 'Sun Logistics', content: { phone: '+91 80 41XX XXXX', address: 'Plot 12, Freight Corridor', associates_count: 5, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: [] }, x: 650, y: 430, color: '#06b6d4' },
    { id: 'pin-godown', board_id: boardId, entity_type: 'building', entity_id: null, label: 'Godown 7', content: { address: 'Plot 12, Freight Corridor', associates_count: 2, linked_cases: ['11111111-1111-1111-1111-111111111111'], linked_firs: [] }, x: 400, y: 500, color: '#f59e0b' },
