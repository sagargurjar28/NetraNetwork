    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="p-4 col-span-1 space-y-3">
          ...
          <div className="flex gap-2 pt-3"><Button size="sm">Download</Button><Button size="sm" variant="secondary">Share</Button><Button size="sm" variant="ghost">Flag</Button></div>
