...
function seed(): Map<string, BoardState> {
  ...
  const pins: BoardPin[] = [
    { id: 'pin-vikram', board_id: boardId, entity_type: 'person', entity_id: 'ENT-001', label: 'Vikram Singh', content: { gender: 'male', phone: '+91 98XXX X2100', address: 'Sector 7, Old Mandi', associates_count: 12, linked_cases: ['C-2024-018'], linked_firs: ['FIR-2024-112'] }, x: 420, y: 280, color: '#dc2626' },
    { id: 'pin-anita', board_id: boardId, entity_type: 'person', entity_id: 'ENT-002', label: 'Anita Rao', content: { gender: 'female', phone: '+91 98XXX X2101', address: 'Lake View Apartments', associates_count: 7, linked_cases: ['C-2024-018'], linked_firs: [] }, x: 640, y: 200, color: '#dc2626' },
